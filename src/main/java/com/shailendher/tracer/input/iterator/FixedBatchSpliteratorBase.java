...
public abstract class FixedBatchSpliteratorBase<T> implements Spliterator<T> {
	...
	public FixedBatchSpliteratorBase(final int characteristics, final int batchSize, final long est) {
		this.characteristics = characteristics | SUBSIZED;
		this.batchSize = batchSize;
		this.est = est;
	}

	public FixedBatchSpliteratorBase(final int characteristics, final int batchSize) {
		this(characteristics, batchSize, Long.MAX_VALUE);
	}

	public FixedBatchSpliteratorBase(final int characteristics) {
